...
## [2.9.0](https://github.com/hiddentao/clockwork-engine/compare/v2.7.2...v2.9.0) (2025-12-18)
...
* **events:** remove timestamp from event interfaces ([b4ceef7](https://github.com/hiddentao/clockwork-engine/commit/b4ceef770847987898dcdc88d9dfc831ce0db2f1))
...
* **browser:** remove obsolete timestamp test ([b516602](https://github.com/hiddentao/clockwork-engine/commit/b51660211f8306df06b8429d749a24920faf4bb0))
...
## [2.7.6](https://github.com/hiddentao/clockwork-engine/compare/v2.7.2...v2.7.6) (2025-12-12)
...
## [2.7.3](https://github.com/hiddentao/clockwork-engine/compare/v2.7.2...v2.7.3) (2025-12-12)
...
* **loader:** make HeadlessLoader wrap an actual loader ([4d04f6e](https://github.com/hiddentao/clockwork-engine/commit/4d04f6e0b20d82aba5866d1e86c3c6ae3b2d9b0d))
...
* **replay:** change stopReplay to end game instead of pause ([3ec1293](https://github.com/hiddentao/clockwork-engine/commit/3ec129384c803648e0b01a63640f3e6980d4abe3))
...
* **demo:** add procedurally generated sound effects ([8a245f6](https://github.com/hiddentao/clockwork-engine/commit/8a245f6a8cf9c58d88fcad77047710f33288a5e6))
...
* remove unneeded end check ([2a2f6a7](https://github.com/hiddentao/clockwork-engine/commit/2a2f6a7f3ff82b3c1e39bab815bec604ce7abfcd))
...
* prevent replay tick processing during state transitions ([#1](https://github.com/hiddentao/clockwork-engine/issues/1)) ([e186003](https://github.com/hiddentao/clockwork-engine/commit/e186003cb97d5f270a9480aecdb0eae9bad02119))
...
* add color utility functions for hex parsing and darkening ([ed06c6b](https://github.com/hiddentao/clockwork-engine/commit/ed06c6bded90196395b404760f521e07a225e456))

## [1.8.1](https://github.com/hiddentao/clockwork-engine/compare/v1.8.0...v1.8.1) (2025-10-19)


### Code Refactoring

* rename GameConfig.initialState to gameSpecific and remove snake-specific properties ([5a7b073](https://github.com/hiddentao/clockwork-engine/commit/5a7b073e5b702d14eab7aee09f2b1de82e2c8804))
